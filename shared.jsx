...
const Photo = ({ caption = "", overlay = "", pill = "Photo: Place", style = {}, className = "", dark = false }) => (
  <div className={`photo ${dark ? "dark" : ""} ${className}`} style={style}>
    <div className="photo-pill">{pill}</div>
