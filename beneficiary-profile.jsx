          ...
          <div className="bp-hero-grid">
            ...
            <Reveal delay={240}>
              ...
              <div className="panel" style={{background:"var(--green)",color:"var(--cream)",borderColor:"var(--green)"}}>
                ...
                <p style={{fontSize:13,lineHeight:1.6,margin:"10px 0 0",color:"rgba(247,244,238,.78)"}}>Identity, displacement and enrolment attested by Cairo partner. Last attestation: 18 Apr 2026.</p>
              </div>
            </Reveal>
          </div>
        </div>
