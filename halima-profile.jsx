          ...
          <div className="bp-hero-grid">
            ...
            <Reveal delay={240}>
              ...
              <div className="panel" style={{background:"var(--green)",color:"var(--cream)",borderColor:"var(--green)"}}>
                ...
                <p style={{fontSize:13,lineHeight:1.6,margin:"10px 0 0",color:"rgba(247,244,238,.78)"}}>Credentials and professional background attested by program partner. Last update: 20 Apr 2026.</p>
              </div>
            </Reveal>
          </div>
        </div>
        ...
        <div className="bp-body">
          ...
          <aside>
            ...
            <div className="panel">
              ...
              <a href="beneficiary-profile.html" className="activity-item" style={{color:"var(--ink)",display:"flex"}}><span className="when">K-2384</span><span>Maryam A. · Education · Cairo</span></a>
